...
:point_right: **streamlit univeristat potsdam devops application**: web application for Universitat Potsdam, [slurm-applicator](https://github.com/gauravcodepro/streamlit-up-application) 
