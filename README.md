...
- I only apply to areas and places of interest.
...
- **Web Develpoment**
  - Priority Language: Rails, Python Shiny/ShinyExpress, Streamlit, Django, Julia, Flask, Javascript, Typescript
- **Application Development**
  - Priority Language: Electron, PyQT
- **ARCpy**
